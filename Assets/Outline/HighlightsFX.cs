...
public class HighlightsFX : MonoBehaviour 
{
    ...
    private void Awake()
	{
        ...
        m_blurMaterial = new Material(Shader.Find("Custom/FastBlur"));
    ...
    private void RecreateCommandBuffer()
    {
        ...
        m_commandBuffer.SetRenderTarget(m_highlightRTID);
        ...
        //m_commandBuffer.Blit(m_highlightRTID, BuiltinRenderTextureType.CameraTarget, m_highlightMaterial, (int)0);
    ...
    {
        Graphics.Blit(source, destination, m_highlightMaterial, (int)0);
    }
}
